...
class PostForm extends FormAbstract
{
    ...
    public function buildForm()
    {
        ...
        if ($this->getModel()) {
            ...
            $published_at = $this->getModel()->published_at;
            $temp_time =  strtotime($published_at);
            $published_at = date('Y-m-d', $temp_time);
        }
...
//            ])
            ->add('published_at', 'text', [
                'label' => trans('plugins/blog::posts.published_at'),
                'label_attr' => ['class' => 'control-label required'],
                'attr' => [
