...
class PostController extends BaseController
{
    ...
    public function create(FormBuilder $formBuilder)
    {
        ...
        return $formBuilder->create(PostForm::class)->exclude(['format_type'])->renderForm();
    }
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        return $formBuilder->create(PostForm::class, ['model' => $post])->exclude(['format_type'])->renderForm();
    }
