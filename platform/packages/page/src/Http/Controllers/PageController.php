...
class PageController extends BaseController
{
     ...
     */
    public function __construct(PageInterface $pageRepository, SlugInterface $slugRepository)
    {
    ...
    public function update($id, PageRequest $request, BaseHttpResponse $response)
    {
        ...
        $request->slug = array_pop($arraySlug);
        $permalink = implode('/', $arraySlug);  // not sure to add up $permalink or just update
