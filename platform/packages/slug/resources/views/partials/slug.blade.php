...
@else
    <div class="form-group @if ($errors->has('slug')) has-error @endif">
        ...
        {!! Form::permalink('slug', $modifiedSlug, $object->slug_id, $prefix, SlugHelper::canPreview(get_class($object)) && $object->status != \Botble\Base\Enums\BaseStatusEnum::PUBLISHED) !!}
        {!! Form::error('slug', $errors) !!}
    </div>
@endif
