    ...
    <nav>
        <ul class="pagination">
            ...
            @if ($paginator->onFirstPage())
                <li class="page-item btn disabled" aria-disabled="true" aria-label="@lang('pagination.previous')">
            ...
            @else
                <li class="page-item btn disabled" aria-disabled="true" aria-label="@lang('pagination.next')">
